...
<a href="emailto:support@websitename.com"><i class="fa fa-envelope"></i> support@websitename.com</a>
</span>
<span>
...
<option value="0">Truck Load</option>
...
<option value="0">Distance To Travel</option>
...
<option value="0">Logistic Type</option>
<option value="home">Home Shift</option>
<option value="food">Food Commodities</option>
<option value="essential">Essential Commodities</option>
<option value="electric">Electic Products</option>
<option value="other">Other</option>
</select>
</fieldset>
<fieldset class="half-column">
<span><h3>Estimation: $1500</h3></span>
<span><button onclick="validate()" class="btn1">Estimate</button></span>
</fieldset>
</form>
</div>
</section>
...
<span><h1 class="title">140</h1>
<p>Employees in Team</p></span>
</div>
<!--CARD END-->
<!--CARD BEGINING-->
<div class="card">
...
<span><h1 class="title">2500 KM</h1>
<p>Weekly Travel</p></span>
</div>
<!--CARD END-->
</section>
<section>
...
<span><h1 class="title">500</h1>
<p>Regular Clients</p></span>
</div>
<!--CARD END-->
<!--CARD BEGINING-->
<div class="card active">
<span><i class="fa fa-check-square-o"></i></span>
<span><h1 class="title">5500</h1>
<p>Average Deliveries Done</p></span>
</div>
<!--CARD END-->
</section>
</div>
